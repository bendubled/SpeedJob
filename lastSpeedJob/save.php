 <div id="map" style="position:absolute; width:25%; height:25%; background:grey" ></div>
...
var APPLICATION_ID = 'GFqbwrojInIhqhNFuFWw',
  APPLICATION_CODE = 'laYEl1TgAffv7-r7qDnXlA';
...
function addSuggestionsToPanel(response){
   var suggestions = document.getElementById('suggestions');
   suggestions.innerHTML = JSON.stringify(response.suggestions[0].label, null, ' ');
//   suggestions.innerHTML = JSON.stringify(response.suggestions[0].address.postalCode, null, ' ');
}
...
function auto(response){
 ...
 var content =  '<strong style="font-size: large;">' + 'Geocoding Autocomplete'  + '</strong></br>';
  ...
  content  += '<br/><input type="text" id="auto-complete" style="margin-left:5%; margin-right:5%; min-width:90%"  onkeyup="return autoCompleteListener(this, event);"><br/>';
//  content  += '<br/><strong>Response:</strong><br/>';
  content  += '<div style="margin-left:5%; margin-right:5%;"><pre style="max-height:235px"><code  id="suggestions" onclick=auto() style="font-size: small;">' +'{}' + '</code></pre></div>';
